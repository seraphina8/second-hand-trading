      ...
      <template v-slot:searchForm>
        <el-form ref="searchForm" :model="searchForm" inline>
          ...
          <el-form-item label="验证码" prop="code">
            <el-input v-model="searchForm.code" clearable placeholder="请输入验证码"></el-input>
          </el-form-item>
          <el-form-item label="短信内容" prop="content">
            <el-input v-model="searchForm.content" clearable placeholder="请输入短信内容"></el-input>
          </el-form-item>
          <el-form-item label="">
        ...
        <el-form :model="formData" label-width="100px" class="demo-ruleForm">
          <slot name="content">
            ...
            <el-form-item label="过期时间">
              <el-input v-model="formData.expirationTime"></el-input>
            </el-form-item>
...
export default {
  ...
  methods: {
    ...
    getList() {
      ...
      this.request.get("/sysSmsCode/page", {
        params: data
      }).then(res => {
    ...
    submit() {
      ...
      if (this.formData.id === undefined) {
        this.request.post("/sysSmsCode", this.formData).then(res => {
          if (res.code === 200) {
        ...
        //更新
        this.request.put("/sysSmsCode", this.formData).then(res => {
          if (res.code === 200) {
            this.isDrawerDialog = false
            this.$message({
              message: res.msg,
    ...
    batchDelete(rows) {
      ...
      this.$confirm(`此操作将永久删除ID为[${ids}]的数据, 是否继续?`, '提示', {
        ...
        //批量删除数据
        this.request.delete("/sysSmsCode", {data: ids}).then(res => {
          if (res.code === 200) {
            this.$message({
              message: res.msg,
              type: 'success'
