    ...
    <admin-page>
      <template v-slot:searchForm>
        <el-form ref="searchForm" :model="searchForm" inline>
          <el-form-item label="沟通商品名称" prop="productName">
            <el-input v-model="searchForm.productName"></el-input>
          </el-form-item>
          <el-form-item label="买家" prop="user1Id">
            <el-input v-model="searchForm.user1Name"></el-input>
          </el-form-item>
          <el-form-item label="卖家" prop="user2Id">
            <el-input v-model="searchForm.user2Name"></el-input>
          </el-form-item>
          <el-form-item label="">
...
<!--      </template>-->
      <template v-slot:table>
        <el-table ref="multipleTable"
          ...
          <el-table-column prop="product.name" label="沟通商品名称"></el-table-column>
          <el-table-column prop="user1.userName" label="买家"></el-table-column>
          <el-table-column prop="user2.userName" label="卖家"></el-table-column>
        ...
        <el-form :model="formData" label-width="100px" class="demo-ruleForm">
          <slot name="content">
            ...
            <el-form-item label="图片">
              <MyUpLoad type="image" :files="formData.avatar" @setFiles="formData.avatar =$event" v-if="isDrawerDialog"></MyUpLoad>
            </el-form-item>
            <el-form-item label="用户1Id">
              <el-input v-model="formData.user1Id"></el-input>
            </el-form-item>
            <el-form-item label="用户2Id">
              <el-input v-model="formData.user2Id"></el-input>
            </el-form-item>
  ...
  methods: {
    ...
    submit() {
      ...
      if (this.formData.id === undefined) {
        this.request.post("/chatRoom", this.formData).then(res => {
          if (res.code === 200) {
        ...
        //更新
        this.request.put("/chatRoom", this.formData).then(res => {
          if (res.code === 200) {
            this.isDrawerDialog = false
            this.$message({
              message: res.msg,
    ...
    batchDelete(rows) {
      ...
      this.$confirm(`此操作将永久删除ID为[${ids}]的数据, 是否继续?`, '提示', {
        ...
        //批量删除数据
        this.request.delete("/chatRoom", {data: ids}).then(res => {
          if (res.code === 200) {
            this.$message({
              message: res.msg,
              type: 'success'
