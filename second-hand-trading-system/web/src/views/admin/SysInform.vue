    ...
    <admin-page>
      <template v-slot:searchForm>
        <el-form ref="searchForm" :model="searchForm" inline>
          ...
          <el-form-item label="置顶" prop="winTop">
            <el-select v-model="searchForm.winTop" clearable>
      ...
      <template v-slot:table>
        <el-table ref="multipleTable"
          ...
          <el-table-column prop="winTop" label="置顶"></el-table-column>
        ...
        <el-form :model="formData" label-width="100px" class="demo-ruleForm">
          <slot name="content">
            ...
            <el-form-item label="置顶">
              <el-radio v-model="formData.winTop" label="是">是</el-radio>
              <el-radio v-model="formData.winTop" label="否">否</el-radio>
            </el-form-item>
...
export default {
  ...
  methods: {
    ...
    getList() {
      ...
      this.request.get("/sysInform/page", {
        params: data
      }).then(res => {
    ...
    submit() {
      ...
      if (this.formData.id === undefined) {
        this.request.post("/sysInform", this.formData).then(res => {
          if (res.code === 200) {
        ...
        //更新
        this.request.put("/sysInform", this.formData).then(res => {
          if (res.code === 200) {
            this.isDrawerDialog = false
            this.$message({
              message: res.msg,
    ...
    batchDelete(rows) {
      ...
      this.$confirm(`此操作将永久删除ID为[${ids}]的数据, 是否继续?`, '提示', {
        ...
        //批量删除数据
        this.request.delete("/sysInform", {data: ids}).then(res => {
          if (res.code === 200) {
            this.$message({
              message: res.msg,
              type: 'success'
